...
import be.vdab.makers.ContentMaker;
import be.vdab.makers.PresentationMaker;
import be.vdab.makers.SlideMaker;
...
public class Quickstart {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String title = "Presentation: Hello World";
        Presentation presentation = new PresentationMaker().createNewPresentation(service, title);
        SlideMaker slideMaker = new SlideMaker();
        ContentMaker contentMaker = new ContentMaker();
        for (int i = 0; i<5; i++) {
            CreateSlideResponse slide = slideMaker.createNewSlideForPresentation(service, presentation);
            contentMaker.createNewContentForSlide(service,presentation,slide);
        }
    }
}
