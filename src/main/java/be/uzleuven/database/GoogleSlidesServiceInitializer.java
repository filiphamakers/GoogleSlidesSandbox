...
public class GoogleSlidesServiceInitializer {

    private static Slides googleSlidesService = null;
    ...
    private static final String CLIENT_SECRET_PATH = "C:/Users/fhamak0";

    static Slides getInstance(){
        if (googleSlidesService == null) {
            try {
                googleSlidesService = getSlidesService();
    ...
    private static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                new FileInputStream(CLIENT_SECRET_PATH + "/client_secret.json");
